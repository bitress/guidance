...
if (isset($_POST['login'])) {
    ...
    if($fetch['password'] == $password){
        ...
        $_SESSION['student'] = $fetch['student_id'];

        header('Location: '. BASE_URL);

    }else{

        $error = "<center><label class='text-danger'>Invalid username or password</label></center>";
				...
				<div class="col-sm-10 col-md-8 col-lg-6 mx-auto d-table h-100">
					...
					<div class="d-table-cell align-middle">
						...
						<div class="text-center mt-4">
							...
							<a href="/admin" class="h2">Guidance Counseling Management System</a>
								...
								<div class="m-sm-4">
									...
									<form method="POST" action="login.php">
										...
										<div class="mb-3">
											...
											<input class="form-control form-control-lg" type="text" name="student_id" placeholder="Enter your ID" />
										...
										<div class="text-center mt-3">
											...
											<button type="submit" name="login" class="btn btn-lg btn-primary mb-3">Sign in</button> <br>
											

											<p class="mt-2"><a href="register.php" target="_blank" rel="noopener noreferrer">Register</a></p>
